...
function [r1, r2, r3, r4, r5, e] = intesities_no_display(lambda1, lambda2, mu1, mu2, mu3, mu4, mu5)
  r1 = (lambda1/mu1);
  r2 = ((lambda2+(2/7)*lambda1)/mu2);
  r3 = ((4/7)*lambda1/mu3);
  r4 = ((3/7)*lambda1/mu4);
...
function [Q1, Q2, Q3, Q4, Q5] = mean_clients(lambda1, lambda2, mu1, mu2, mu3, mu4, mu5)
  [r1, r2, r3, r4, r5, e] = intesities_no_display(lambda1, lambda2, mu1, mu2, mu3, mu4, mu5);
  Q1 = r1/(1-r1);
  Q2 = r2/(1-r2);
  Q3 = r3/(1-r3);
  Q4 = r4/(1-r4);
