...
figure(1);
plot(to_plot,"c","linewidth",1.3);
title("Average number of clients in the M/M/1 queue: Convergence, lambda=1");
...
figure(1);
plot(to_plot,"c","linewidth",1.3);
title("Average number of clients in the M/M/1 queue: Convergence, lambda=5");
xlabel("transitions in thousands");
ylabel("Average number of clients");
...
figure(1);
plot(to_plot,"c","linewidth",1.3);
title("Average number of clients in the M/M/1 queue: Convergence, lambda=10");
xlabel("transitions in thousands");
ylabel("Average number of clients");
